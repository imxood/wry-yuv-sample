...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_openDecoder')) {
        Object.defineProperty(Module['ready'], '_openDecoder', { configurable: true, get: function() { abort('You are getting _openDecoder on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_openDecoder', { configurable: true, set: function() { abort('You are setting _openDecoder on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_flushDecoder')) {
        Object.defineProperty(Module['ready'], '_flushDecoder', { configurable: true, get: function() { abort('You are getting _flushDecoder on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_flushDecoder', { configurable: true, set: function() { abort('You are setting _flushDecoder on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_closeDecoder')) {
        Object.defineProperty(Module['ready'], '_closeDecoder', { configurable: true, get: function() { abort('You are getting _closeDecoder on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_closeDecoder', { configurable: true, set: function() { abort('You are setting _closeDecoder on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_decodeData')) {
        Object.defineProperty(Module['ready'], '_decodeData', { configurable: true, get: function() { abort('You are getting _decodeData on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_decodeData', { configurable: true, set: function() { abort('You are setting _decodeData on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
var wasmBinaryFile;
if (Module['locateFile']) {
  wasmBinaryFile = 'ffmpeg_264_265.wasm';
  if (!isDataURI(wasmBinaryFile)) {
    wasmBinaryFile = locateFile(wasmBinaryFile);
  }
} else {
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  wasmBinaryFile = new URL('ffmpeg_264_265.wasm', import.meta.url).toString();
}
...
/** @type {function(...*):?} */
var _flushDecoder = Module["_flushDecoder"] = createExportWrapper("flushDecoder");

/** @type {function(...*):?} */
var _closeDecoder = Module["_closeDecoder"] = createExportWrapper("closeDecoder");
...
var _ff_h264_cabac_tables = Module['_ff_h264_cabac_tables'] = 78172;
